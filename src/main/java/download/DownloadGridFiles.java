...
//        helper.setHost("mongodb://192.168.1.170:7900");
        helper.setHost("mongodb://192.168.2.184:7900");
...
//		File directory = new File("/home/aplomb/dev/github/PKUserService/deploy");
        File directory = new File("/Users/huzhanjing/tc_deploy/20181118_1");
    ...
    public static void upload() throws DBException, IOException {
        MongoHelper helper = new MongoHelper();
        helper.setHost("mongodb://192.168.1.55:7900");
//        helper.setHost("mongodb://122.155.11.38:27017");
        helper.setDbName("gridfiles");
//		helper.setUsername("socialshopsim");
//		helper.setPassword("eDANviLHQtjwmFlywyKu");
        helper.init();
        ...
        // upload one file
        File de = new File("/Users/huzhanjing/tc_deploy/20181118_1scripts/imweb/imadminweb_v1/groovy.zip");
        String filePath = de.getAbsolutePath();
        FileAdapter.PathEx path = new FileAdapter.PathEx("/scripts/sdocker_web_all/imadminweb_v1/groovy.zip");
